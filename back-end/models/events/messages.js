module.exports = {
  ...
  TEMPLATE_TEACHER_TASK_UNASSIGN_MSG: `%owner.profile.displayName% unassigned you this task: %task.title%`,
  TEMPLATE_TEACHER_TASK_CONFIRM_COMPLETION_MSG: `%owner.profile.displayName% confirmed your completion of a task: %task.title%`,
  ...
  TEMPLATE_TASK_REWARD_READ: `Reward retrieval for task %task.title% initiated by %owner.profile.displayName%. [%task.rewardList%]`,
  TEMPLATE_TASK_ASSIGN: `%owner.profile.displayName% assigned task %task.title% to %user.profile.displayName%.`,
  TEMPLATE_TASK_UNASSIGN: `%owner.profile.displayName% unassigned task %task.title% from %user.profile.displayName%.`,
  TEMPLATE_TASK_REQUEST_COMPLETION: `%owner.profile.displayName% requested completion of a task: %task.title%`,
  TEMPLATE_TASK_CONFIRM_COMPLETION: `%owner.profile.displayName% confirmed completion of a task: %task.title% for %user.profile.displayName%.`,
  TEMPLATE_TASK_REJECT_COMPLETION: `%owner.profile.displayName% rejected completion of a task: %task.title% for %user.profile.displayName%.`,
  TEMPLATE_TASK_UPDATE: `%owner.profile.displayName% updated a task: %task.title%. [%task.fields%] [%task.values%]`,
  TEMPLATE_TASK_DELETE: `%owner.profile.displayName% deleted a task: %task.title%.`,

...
export const START_GET_ALL_REWARDS = "START_GET_ALL_REWARDS";
export const GET_ALL_REWARDS = "GET_ALL_REWARDS";
export const ERROR_GET_ALL_REWARDS = "ERROR_GET_ALL_REWARDS";
...
export const startGetAllRewards = () => ({
	type: START_GET_ALL_REWARDS
});
...
export const errorGetAllRewards = error => ({
	type: ERROR_GET_ALL_REWARDS,
	error
});
...
export const getAllRewards = (userId, userKind) => async dispatch => {
	...
	try {
		...
		if (!response.success) {
			throw new Error(response.apiError);
		}

		dispatch(getRewards(response.apiData));
	} catch (e) {
		console.error(e);
		dispatch(errorGetAllRewards(e));
	}
};

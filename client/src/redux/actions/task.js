...
export const START_GET_ALL_TASKS = "START_GET_ALL_TASKS";
...
export const errorGetAllTasks = error => ({
	type: ERROR_GET_ALL_TASKS,
	error
});
...
export const hydrateTeacherTasks = userId => async dispatch => {
	...
	try {
		...
		console.log(error);
		dispatch(errorGetAllTasks(error));
	}
};
